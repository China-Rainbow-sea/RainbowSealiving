...
public class TestController {
    ...
    public R testUpload() throws FileNotFoundException {
        ...
        String accessKeyId222 = "LTAI5tP4G6hDJqh7FPe1Cahh";
        String accessKeySecret22 = "vl5kaBORH1QADEzKq9NInpRdD8JJeF";
        ...
        // 创建OSSClient实例。
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId222, accessKeySecret22);
